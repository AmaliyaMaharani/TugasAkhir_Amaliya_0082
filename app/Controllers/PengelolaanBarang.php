...
class PengelolaanBarang extends BaseController
{
    ...
    public function add_data()
    {
        $data = [
            ...
            'content' => 'admin/v_addkelolabarang',
        ];
        echo view('layout/v_wrapper', $data);
    }
    ...
    public function save()
    {
        ...
        $data = [
            'no_barang' => $this->request->getPost('no_barang'), // Pastikan no_barang ada
        ...
        // Menggunakan model untuk menyimpan data ke tabel pengelolaanbarang
        $this->Model_pengelolaanbarang->save($data); // save() berfungsi untuk insert atau update data
